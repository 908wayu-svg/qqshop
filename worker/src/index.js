  ...
  async fetch(request, env) {
    ...
    const closeWrites = [
      ...
      },
      {
        ...
        // ต้องมีเอกสารสมาชิกอยู่จริง ณ ตอนเขียน — เช็คตอนต้นทางอย่างเดียวไม่พอ
        // เพราะเอกสารอาจถูกลบระหว่างที่บอทกำลังกดรับซองอยู่ (ใช้เวลาหลายวินาที)
        // คำสั่งบวกเครดิตจะ "สร้างเอกสารให้" ถ้าไม่มี = ได้สมาชิกผีที่มีแต่ยอดเครดิต
        // ไม่มีชื่อ ไม่มีอีเมล ไม่มีสิทธิ์ โผล่ในหลังบ้านแบบว่างเปล่า
        // ถ้าเงื่อนไขนี้ไม่ผ่าน คำสั่งทั้งชุดถูกปฏิเสธ แล้วตกไปที่ทางสำรองด้านล่าง
        // ซึ่งพักรายการไว้เป็น "รออนุมัติ" พร้อมยอดจริงให้แอดมินจัดการ (เงินเข้าร้านไปแล้ว)
        currentDocument: { exists: true },
      },
    ];
