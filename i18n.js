...
const I18N = {
  th: {
    ...
    confirm_hide_money: "⚠ รายการนี้คือหลักฐานชิ้นเดียวที่อธิบายว่าเครดิตของลูกค้าเปลี่ยนไปเพราะอะไร\n\nซ่อนแล้วลูกค้าจะเห็นยอดเครดิตไม่ตรงกับที่จำได้ แต่หาที่มาไม่เจอ แน่ใจไหม?",
    ...
    please_refresh: "หน้าเว็บที่เปิดอยู่เป็นเวอร์ชันเก่า กรุณารีเฟรชหน้า (กด Ctrl+F5) แล้วลองใหม่",
    logs_search: "ค้นในบันทึก (ชื่อ / อีเมล / การกระทำ)",
    logs_capped: "⚠ มีบันทึกมากกว่านี้ — หน้านี้ดึงมาได้ {n} รายการล่าสุดเท่านั้น การค้นด้านบนจึงค้นได้เฉพาะในก้อนนี้",
  ...
  en: {
    ...
    confirm_hide_money: "⚠ This record is the only thing explaining why the customer’s credit changed.\n\nHide it and their balance will not match what they remember, with nothing to explain it. Are you sure?",
    ...
    logs_reload: "Reload",
    please_refresh: "This page is an older cached version — please refresh (Ctrl+F5) and try again",
    logs_search: "Search the log (name / email / action)",
    logs_capped: "⚠ There are more entries — this page loaded only the latest {n}, so the search above only covers those",
