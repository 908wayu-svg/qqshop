...
const I18N = {
  th: {
    ...
    angpao_link: "ลิงก์ซองอั่งเปา", angpao_hint: "วางลิงก์ซองอั่งเปาที่นี่ ระบบจะส่งให้แอดมินกดรับ",
  ...
  en: {
    ...
    angpao_link: "Angpao link", angpao_hint: "Paste your TrueMoney angpao link — an admin will redeem it",
