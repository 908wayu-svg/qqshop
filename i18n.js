...
const I18N = {
  th: {
    ...
    stock_items_hint: "แต่ละชิ้นคือของ 1 ชุดที่ขายได้ 1 ครั้ง ใส่ชื่อผู้ใช้และรหัสผ่านของชุดนั้น แล้วกดบันทึก",
  ...
  en: {
    ...
    stock_items_hint: "Each row is one set that can be sold once. Fill in its login and password, then save.",
