...
export const SHOP = {
  ...
  // ===== เงื่อนไขการให้บริการ (หน้าต่างสั่งซื้อ + หน้า terms.html) =====
  // claimMinutes = ลูกค้าต้องแจ้งปัญหาภายในกี่ "นาที" หลังได้รับของ ถึงจะเคลม/คืนเครดิตได้
  //   ไอดีเกม  — เริ่มนับทันทีที่ซื้อสำเร็จ (รหัสขึ้นในประวัติการซื้อแล้ว)
  //   เติมเกม  — เริ่มนับตอนแอดมินกด "ทำเสร็จแล้ว"
  // requireVideo = ต้องมีวิดีโอตั้งแต่กดสั่งซื้อจนเข้าเกม/ได้ของ ถึงจะเคลมได้
  // แก้ตรงนี้ที่เดียว หน้าต่างสั่งซื้อ ประวัติการซื้อ และ terms.html เปลี่ยนตามทุกจุดทั้งสองภาษา
  policy: { claimMinutes: 10, requireVideo: true },
...
// ===== หมวดหมู่สินค้าหน้าร้าน =====
// โชว์เป็นแท็บกรองด้านบนตะแกรงสินค้า — เพิ่มหมวดใหม่ได้ที่นี่ที่เดียว
// id ต้องตรงกับค่าที่เลือกไว้ในช่อง "หมวดหมู่" ตอนเพิ่ม/แก้สินค้าในหลังบ้าน
// อย่าลืมเพิ่มคำแปล cat_<id> ในไฟล์ i18n.js ทั้งไทยและอังกฤษด้วย
