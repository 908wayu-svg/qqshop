...
export const SHOP = {
  ...
  // ===== เงื่อนไขการให้บริการ (หน้า terms.html) =====
  // claimHours = ลูกค้าต้องแจ้งปัญหาภายในกี่ชั่วโมงหลังได้รับของ ถึงจะเคลม/คืนเครดิตได้
  // แก้ตัวเลขตรงนี้ที่เดียว หน้า terms.html เปลี่ยนตามทุกจุดทั้งไทยและอังกฤษ
  policy: { claimHours: 24 },
